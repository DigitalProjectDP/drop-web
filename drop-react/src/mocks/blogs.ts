...
import imgArticulo01_01 from "../media/img/blogs/articulo01_01.jpeg"
...
[
    {
        ...
        Nuestra solución, DROP es un sistema de construcción moderno que se encarga de todos los detalles de diseño y montaje que pueden perder relevancia durante enfoques de construcción más tradicionales. Con el diseño modular, el cliente tiene el control del producto final.
        ...
        Esto es así, ya que los módulos DROP, son totalmente flexibles y adaptables, sin importar el momento del proyecto.

        <strong>Diseño para tu proyecto</strong>
        Al elegir un diseño modular, puedes asegurarte de que cada elemento de tus módulos se adapten perfectamente a las necesidades de tu proyecto. Cada módulo puede ser producido según los requisitos exactos de tu ubicación y con las dimensiones y materiales correctos.

        <strong>Personalización Total</strong>
        Cuando eliges la arquitectura modular, el cliente esta tomando el control. Sin importar lo pequeño que sea, DROP puede cumplir con tus solicitudes al diseñar desde una oficina a un centro comercial, totalmente personalizados. 

        <strong>Diseño Sostenible, respetuoso con el medio ambiente</strong>
        En todas las áreas de la arquitectura, la sostenibilidad es más importante que nunca. El proceso de construcción en cadena de montaje modular significa que los residuos se mantienen al mínimo absoluto, mientras que el diseño personalizado significa una menor probabilidad de errores y repeticiones costosas. Esto puede ayudarte a garantizar que tu proyecto cumpla con los estándares modernos de diseño sostenible.
    ...
    },
    {
        ...
        <strong>Mayor retorno de inversión para desarrolladores y propietarios.</strong> Con una finalización de proyecto más temprana, los propietarios pueden comenzar a utilizar el edificio antes, generando más ingresos en general. Además, el m2 en construcción, es llamativamente menor que la construcción tradicional.
        
        <strong>Reducción del cronograma general del proyecto.</strong> La construcción de la base y la cimentación puede realizarse junto con la construcción del módulo, lo cual es una ventaja importante sobre los métodos de construcción tradicionales. Además, se ahorra tiempo con la construcción precisa de todos los módulos antes del transporte, y con la optimización de la fabricación, el transporte y el acabado en el sitio. En algunos casos, los plazos del proyecto se reducen en un 25% o más, y la ocupación por parte del propietario se realiza un mes o más antes de lo previsto.
        
        <strong>Ahorro de costos.</strong> Las inversiones iniciales en diseño y fabricación ayudan a reducir los costos. Los costos también se reducen con menos mano de obra en el lugar, el aumento del número de fábricas de construcción modular y métodos de embalaje y transporte más baratos que los disponibles en el pasado.
        
        <strong>Cumplimiento con normas regulatorias.</strong> Los edificios modulares pueden construirse cumpliendo todas las normas de seguridad y regulatorias como los proyectos construidos tradicionalmente. Se pueden realizar ajustes según los requisitos del lugar. Por ejemplo, para áreas propensas a terremotos, los ingenieros estructurales deciden qué partes de un edificio modular deben soportar más carga.
        
        <strong>Mayor calidad general.</strong> Los módulos suelen estar construidos con madera o acero, y están diseñados como un todo para ser muy fuertes y duraderos. La fabricación en entornos controlados reduce la exposición de las estructuras a las inclemencias del tiempo. Además, el diseño preciso y la exacta replicación entre los módulos reducen los defectos y ayudan a los constructores a cumplir con todos los estándares de calidad de la marca.
        
        <strong>Menos desperdicio.</strong> La precisión en la fabricación y menos ajustes en el lugar significan que los constructores producen menos desperdicio de material que en la construcción tradicional, lo que contribuye a reducir los costos.
        
        <strong>Sostenibilidad ambiental.</strong> Las consideraciones "verdes" en el diseño del proyecto son más alcanzables con la construcción modular. Menos desperdicio y una finalización de proyecto más rápida pueden dar como resultado una menor carga sobre los recursos ambientales.
    ...
    {
        id: 3,
        titulo: '¿Qué es la Construcción Fuera del Sitio o Construcción Offsite?',
        subtitulo: undefined,
        ...
        La construcción de módulos fuera del sitio incorpora una variedad de materiales, escalas y sistemas, métodos innovadores de fabricación, software digital y técnicas modernas de ensamblaje.
        La salida de una construcción fuera del sitio tiene elementos que están componentizados, panelizados y modularizados, que se utilizan como elementos estructurales, elementos de cerramiento y servicio, o como sistemas de partición interior.
        La optimización en la construcción fuera del sitio se logra mediante la integración de estos sistemas y la cadena de suministro con una investigación, diseño, pruebas y prototipado adecuados y eficientes.
...
export const MockBlogs_Old: Imagen[] = 
[
    {
        id: 1,
