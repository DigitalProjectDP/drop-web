...
export default function BancoHipotecarioPopUp() {
    ...
    return (
        <>
            {visible ? <article className="popup__container bg-light p-4 w-50" >
                <Modal.Header closeButton className="border-0" onClick={() => setVisible(false)}></Modal.Header>
                <h1 className="text-center">¿Sabías que podés acceder a un crédito hipotecario para construir tu casa?</h1>
